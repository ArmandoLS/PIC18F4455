;PROGRAMA MULTIPLICADOR DE 2 NUMERO DE 3 BITS QUE INGRESAN EN PA Y EL RESULTADO SE MUESTRA EN PB
    ...
    MULWF N1,W;MULTIPLICA EL VALOR DE N1 Y W. N1=7 Y W=7. PRODH= 00000000 PRODL=00110001
    MOVFF PRODL,LATB; MUEVE EL VALOR DE PRODL A LATB. LATB=49
