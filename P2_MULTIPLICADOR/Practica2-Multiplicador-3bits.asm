;RESTADOR DE 3 BITS QUE INGRESAN DESDE EL PORTA
...
MAIN
    ...
    ;MULTIPLICAMOS COPY * COPY2 Ó COPY * W
    
    MULWF COPY,W    ;W= .7 * .7 -> W=7 | PRODL = .49 Y PRODH=0
    MOVFF PRODL,LATB	    ; MOVEMOS EL .0 AL PORTB
    GOTO MAIN
    END
