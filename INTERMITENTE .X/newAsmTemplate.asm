;PROGRAMA QUE REALIZA LA SUMA PB=PA+25. CONSIDERE
;PROGRAMA PARA ENCENDER DE FORMA INTERMITENTE, EL LED CONECTADO EN RB5
;FRECUENCIA 1MHZ, RETARDO DE 100mS
;    
...
#DEFINE	LED	LATB,5	;LED ES ETIQUETA DEL PIN 5 DEL PORTB
