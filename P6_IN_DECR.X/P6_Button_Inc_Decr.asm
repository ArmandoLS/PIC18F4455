...
; CONFIG7H
 ...
 ;DEFINICIONES
 #DEFINE LED LATB,0
 #DEFINE BOTONI PORTE,RE1
 #DEFINE BOTOND PORTE,RE0
 #DEFINE CONTADOR .12
 ;DEFINICIONES
		;pGFE DCBA
...
AGAIN
    ...
    RETURN
DECODIFICA
    MOVFF CONTADOR, WREG;MOVEMOS EL CONTADOR A W
    RLNCF WREG,F ;ROTAMOS SU VALOR
    CALL TABLA_03
    MOVWF LATD
    RETURN
...
SETTINGS
    CLRF PORTE
    SETF TRISE ;LOS PINES RE SON INPUTS
    MOVLW H'0F'
